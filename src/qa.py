...
class QASystem:
    ...
    def add_documents(self, chunks: List[Dict[str, Any]], metadata: Dict[str, Any] = None) -> str:
        """
        문서 추가
        Args:
    ...
    def ask(self, question: str, category: Optional[str] = None) -> Dict[str, Any]:
        ...
        # GPT를 사용하여 답변 생성
        answer = self._create_chat_completion("주어진 컨텍스트를 기반으로 질문에 답변해주세요. 컨텍스트에 없는 내용은 답변하지 마세요.", f"컨텍스트:\n{context}\n\n질문: {question}")
